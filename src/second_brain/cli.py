"""Unified CLI for the complete Second Brain for Devs workflow."""
...
from second_brain.app import build_evaluator, build_orchestrator
from second_brain.config import load_config
from second_brain.evaluation.evaluator import EvaluationReport
from second_brain.orchestration.llm_client import LLMClient
from second_brain.orchestration.llm_client import LLMClientError
...
def _cmd_doctor(args: argparse.Namespace) -> int:
    ...
    _print_section("Second Brain Doctor", "\n".join(checks))
...
def _cmd_chat(args: argparse.Namespace) -> int:
    ...
    print("Second Brain for Devs. Type 'exit' or 'quit' to stop.")
    while True:
        question = input("\nQuestion> ").strip()
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(description="Second Brain for Devs unified CLI.")
