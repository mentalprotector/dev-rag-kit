"""FastAPI web UI for Repo Sentinel."""
...
from second_brain.repo_intel.graph import run_repo_intel
...
def create_app() -> Any:
    """Create the Repo Sentinel web app."""
    ...
    app = FastAPI(title="Repo Sentinel", version="0.1.0")
  ...
  <main class="shell">
    ...
    <section class="grid">
      <aside class="panel">
        ...
        <div class="hint">Reports are written to <code>.reposentinel/</code>. The UI calls the same runner as the CLI.</div>
      </aside>
      <section class="panel">
        <div class="tabs">
