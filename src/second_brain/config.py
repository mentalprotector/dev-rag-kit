"""Configuration loading for Second Brain for Devs."""
...
class QdrantConfig(BaseModel):
    ...
    collection: str = Field(default="second_brain_docs", min_length=1)
...
class LLMConfig(BaseModel):
    ...
    model_name: str = Field(default="google/gemma-4-26b-a4b", min_length=1)
